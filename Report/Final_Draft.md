...
How has snowfall at Massanutten changed over time?
How does snowfall change over time correlate with temperature change?
How has the number of days of snowfall per year changed over time?
...
link : https://daac.ornl.gov/DAYMET/guides/Daymet_Daily_V4.html 
NOAA Dale Enterprise Station Dataset
A third dataset was obtained from the National Oceanic and Atmospheric Administration Climate Data Online archive. Data from the Dale Enterprise station served as a long-term regional proxy for snowfall and winter temperature trends.

This dataset spans from 1893 through 2026, providing over 130 years of climate observations. This dataset enabled multi-decade trend analysis of snowfall and winter temperature changes in the region.
